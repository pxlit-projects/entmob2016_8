...
namespace HeadphoneApp.Droid.Services
{
    class GattCallback : BluetoothGattCallback
    {
        ...
        private HeadphoneApp.Model.Service ConvertService(BluetoothGattService service)
        {
            var serviceModel = new HeadphoneApp.Model.Service
            {
